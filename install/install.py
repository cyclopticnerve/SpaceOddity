...
<<<<<<< HEAD
P_DIR_USR_INST = Path.home() / ".local/share/spaceoddity"
P_DIR_VENV = P_DIR_USR_INST / ".venv-spaceoddity"
...
P_FILE_DESK = P_DIR_ASSETS / "src/gui/desktop/SpaceOddity.desktop"
P_FILE_DESK_ICON = P_DIR_ASSETS / "images/spaceoddity.png"

S_ENCODING = "UTF-8"
=======
P_DIR_INSTALL = P_DIR_ASSETS / "install"
P_DIR_VENV = Path.home() / ".local/share/spaceoddity/.venv-spaceoddity"

# get files
P_FILE_CFG_UNINST = (
    Path.home() / ".local/share/spaceoddity/install/install.json"
)
P_FILE_CFG = P_DIR_INSTALL / "install.json"
P_FILE_REQS = P_DIR_INSTALL / "requirements.txt"
P_FILE_DESK = P_DIR_ASSETS / "src/gui/desktop/SpaceOddity.desktop"
P_FILE_DESK_ICON = (
    P_DIR_ASSETS / ".local/share/spaceoddity/images/spaceoddity.png"
)
